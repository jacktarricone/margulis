...
pixel_area <-rast("/Volumes/JT/projects/margulis/static/rasters/SNSR_pixel_area.tif")
...
usj_raw <-vect("/Volumes/JT/projects/margulis/ari/USJW_Watershed_shape/Watershed_USJ.shp")
plot(usj_raw)
...
dem <-rast("/Volumes/JT/projects/margulis/static/rasters/SNSR_dem.tif")
